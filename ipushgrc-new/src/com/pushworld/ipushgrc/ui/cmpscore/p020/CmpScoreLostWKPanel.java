...
public class CmpScoreLostWKPanel extends AbstractWorkPanel implements ActionListener {
	...
	public void onInsert() {
		...
		BillCardDialog cardDialog = new BillCardDialog(this, "直接新增违规积分", cardPanel, WLTConstants.BILLDATAEDITSTATE_INSERT);
	...
	public void onInsertFromEvent() {
		...
		listpanel.addBillListButton(WLTButton.createButtonByType(WLTButton.LIST_SHOWCARD));//增加浏览按钮【李春娟/2012-03-28】
		listpanel.repaintBillListButton();
		...
		format.setMaximumIntegerDigits(1);//整数位至少有一位【李春娟/2016-03-11】
