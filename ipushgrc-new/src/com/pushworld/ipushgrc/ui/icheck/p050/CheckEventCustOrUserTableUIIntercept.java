...
/**
 *单机版检查管理检查实施，发现问题，问题引用违规事件引用涉及员工的拦截器类【李春娟/2016-09-05】
 *修改主键生成机制
 * @author lcj
 *
 */
public class CheckEventCustOrUserTableUIIntercept implements ChildTableCommUIIntercept, ActionListener {
	...
	private void onInsert() {
		try {
			...
			String cmp_wardevent_id = (mainCardPanel).getRealValueAt("id"); //
			cardPanel.setCompentObjectValue("cmp_wardevent_id", new StringItemVO(cmp_wardevent_id)); //
