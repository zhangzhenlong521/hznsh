...
public class LawItemEditDialog extends BillDialog implements ActionListener, BillTreeSelectListener {
	...
	private BillTreePanel billTree_lawitem = null; // 条目树！
	private BillCardPanel billCard_lawitem = null; // 条目卡片编辑面板

	private BillVO selectLaw = null; //当前选择的法规VO

	private JMenuItem item_insert, item_delete; //添加，删除 
