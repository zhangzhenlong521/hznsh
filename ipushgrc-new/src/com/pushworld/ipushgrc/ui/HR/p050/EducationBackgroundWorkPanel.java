 ...
 * 学历津贴维护
 */
public class EducationBackgroundWorkPanel extends AbstractWorkPanel implements
ActionListener{
	...
	public void initialize() {
		list=new BillListPanel("PUB_COMBOBOXDICT_ZZL_CODE1");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==onnew){
			final BillCardDialog db=new BillCardDialog(this,"学历津贴维护","PUB_COMBOBOXDICT_ZZL_CODE1",600,400);
