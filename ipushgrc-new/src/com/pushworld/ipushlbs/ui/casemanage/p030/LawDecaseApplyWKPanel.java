 ...
 * 
 */
public class LawDecaseApplyWKPanel extends AbstractWorkPanel implements ActionListener, BillListSelectListener {
	...
	public void initialize() {
		list = new BillListPanel("LBS_CASE_DECASE_CODE1");
