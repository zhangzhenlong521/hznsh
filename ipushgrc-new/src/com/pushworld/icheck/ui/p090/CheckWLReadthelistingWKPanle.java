...
public class CheckWLReadthelistingWKPanle extends AbstractWorkPanel implements BillListSelectListener, ActionListener, BillListHtmlHrefListener{

	private BillListPanel listPanel=null;
	public void initialize() {
		listPanel=new BillListPanel("WL_CK_DYQINDAN_CODE1");
		this.add(listPanel);
	}
