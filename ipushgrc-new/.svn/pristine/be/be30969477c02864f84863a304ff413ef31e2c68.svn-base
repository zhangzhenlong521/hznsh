...
/**
 * 问题录入
 * 与 类 com.pushworld.ipushgrc.ui.icheck.p050.CheckProblemAloneDialog 类似
 * 如需修改，同时修改
 * @author shaochunyun
 *
 */
...
//			MessageBox.show(card_panel, "请您先填写结果描述！");
//			return;
//		}//客户不愿意录入【ZZL】
		...
		dialog.billcardPanel.setValueAt("importance", new StringItemVO(billvo.getStringValue("important"))); //问题重要性
