 ...
 *  工作流的动态参与者： 找子流程的创建人
 */
public class WFDynamicChildCreateUser implements WorkflowDynamicParticipateIfc {
	...
	public WorkFlowParticipantBean getDynamicParUsers(String loginuserid, BillVO billvo, HashVO dealpool, String transitionCode, String transitionDealTyp, String fromactivityCode, String curractivityCode, String curractivityName) throws Exception {
		...
		// 子流程的创建人
		String create_Userid = dealpool.getStringValue("wf_prinstance_creater_id");
		// 流程创建人的 部门
		...
		ParticpantUserBeans[0].setUserrolename("子流程创建人");
		ParticpantUserBeans[0].setUserrolecode("子流程创建人");
