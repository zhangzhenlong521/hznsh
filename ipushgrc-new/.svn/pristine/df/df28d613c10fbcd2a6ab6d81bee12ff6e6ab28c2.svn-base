...
/**
 * 在参考某个流程图时，需要可以编辑其他的一图两表，故弄了个frame【李春娟/2012-07-18】
 * 注意修改此类，要考虑是否同时修改WFGraphEditItemFrame类！！！
 * @author lichunjuan
 *
 */
public class WFGraphEditItemFrame extends BillFrame implements ActionListener {
	...
	public WFGraphEditItemFrame(Container _parentContainer, String _title, String _processid, boolean _editable, boolean _showRefPanel) {
		this(_parentContainer, _title, _processid, _editable, _showRefPanel, 1000, 700);
	}

	public WFGraphEditItemFrame(Container _parentContainer, String _title, String _processid, boolean _editable, boolean _showRefPanel, int _width, int _height) {
		this(_parentContainer, _title, _processid, null, _editable, _showRefPanel, _width, _height);
	}

	// 可以传入高亮环节框数组
	public WFGraphEditItemFrame(Container _parentContainer, String _title, String _processid, String[] _activityid, boolean _editable, boolean _showRefPanel) {
	 ...
	 *            高
	 */
	public WFGraphEditItemFrame(Container _parentContainer, String _title, String _processid, String[] _activityid, boolean _editable, boolean _showRefPanel, int _width, int _height) {
