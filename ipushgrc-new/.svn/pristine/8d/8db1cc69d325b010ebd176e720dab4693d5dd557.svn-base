...
public class CmpfileAndWFGraphDialog extends BillDialog implements ChangeListener {
	...
	public CmpfileAndWFGraphDialog(Container _parentContainer, String _title, String _cmpfileid) {
		this(_parentContainer, _title, _cmpfileid, 1000, 700);
	}

	public CmpfileAndWFGraphDialog(Container _parentContainer, String _title, String _cmpfileid, String _tabcount) {
	...
	public CmpfileAndWFGraphDialog(Container _parentContainer, String _title, String _cmpfileid, int _width, int _height) {
