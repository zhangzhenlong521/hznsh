package com.pushworld.ipushgrc.ui.cmpreport;
...
public class CommonDialPlotPanel extends DialPlotPanel {
	 ...
	 *            仪表盘类型(为满足个性化需求)
	 */
	public CommonDialPlotPanel(double _outerValue, double _innerValue, double _outerMaxValue, double _outerMinValue, double _innerMaxValue, double _innerMinValue, double _highValue, double _lowValue, double _showOuterNumValue, double _showInnerNumValue, String _topName, String _bottomName,
			String _type) {
	...
	public static JPanel getDialPlotPanelByHashVO(HashVO _hvo, boolean _type) throws Exception {
		...
		double li_value3;
		if (_type) {//如果预警值大于正常值
			li_value2 = _hvo.getDoubleValue("正常值", (double) 30); //
			li_value3 = _hvo.getDoubleValue("警界值", (double) 60); //
		} else {
			li_value2 = _hvo.getDoubleValue("警界值", (double) 30); //
			li_value3 = _hvo.getDoubleValue("正常值", (double) 60); //
		}
		...
		JPanel diaPlotPanel = getDialPlotPanel(str_title, str_x, li_realValue, li_value1, li_value2, li_value3, li_value4, bgColor, str_tip, _type); //
		diaPlotPanel.setPreferredSize(new Dimension(400, 400));
		...
		double[][] ld_data = (double[][]) diaPlotPanel.getClientProperty("Data"); //
		return getPanel(diaPlotPanel, title, x, y, ld_data, 400);
	}
	 ...
	 * @throws Exception
	 */
	private static JPanel getPanel(JPanel _newChartPanel, String _title, String[] _x, String[] _y, double[][] _data, int _splitdivlocation) throws Exception {
		...
		WLTSplitPane split = new WLTSplitPane(WLTSplitPane.VERTICAL_SPLIT, jp, scroll); //
	...
	private static org.jfreechart.chart.ChartPanel getDialPlotPanel(String _topName, String _bottomName, double _realValue, double _value1, double _value2, double _value3, double _value4, Color _bgColor, String _tip, boolean _type) {
