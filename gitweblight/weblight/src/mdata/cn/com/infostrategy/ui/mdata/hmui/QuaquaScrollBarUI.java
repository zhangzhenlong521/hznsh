...
public class QuaquaScrollBarUI extends BasicScrollBarUI {
	...
	public static int sizeLessThanNumHidBtn = 85; //横线的长度和纵向的高度如果小于这个值，则不显示点击按钮。
	...
	protected void layoutVScrollbar(JScrollBar sb) {
		...
		boolean isSmall = isSmallSizeStyle();
		boolean sizeLessThan80 = false; //判断是否小于80大小。如果小于，就去掉上下按钮
	...
	protected class QuaquaArrowButtonListener extends ArrowButtonListener {
		public void mousePressed(MouseEvent evt) {
			switch (scrollbar.getOrientation()) {//即便按钮为0，0大小。点击边界也会执行此事件。所有过滤一下。
			case JScrollBar.VERTICAL:
