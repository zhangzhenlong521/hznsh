 ...
 *
 */
public class RefDialog_QueryMulti extends AbstractRefDialog implements BillListMouseDoubleClickedListener {
	...
	public RefDialog_QueryMulti(Container _parent, String _title, RefItemVO _refinitvalue, BillPanel _billPanel, CommUCDefineVO _dfvo) {
	...
	public RefDialog_QueryMulti(Container _parent, String _title, RefItemVO _refinitvalue, BillPanel _billPanel, String[] _allcolumns, HashVO[] _vos, String _value) {
		super(_parent, _title, _refinitvalue, _billPanel); //
