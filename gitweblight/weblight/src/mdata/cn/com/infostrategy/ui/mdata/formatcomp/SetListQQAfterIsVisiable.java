...
public class SetListQQAfterIsVisiable extends PostfixMathCommand {
	private BillFormatPanel formatpanel = null; //

	public SetListQQAfterIsVisiable(BillFormatPanel _billcellpanel) {
	...
	public void run(Stack inStack) throws ParseException {
		...
		final Object second_panel = inStack.pop(); //被刷新的面板
		final Object main_panel = inStack.pop(); //被刷新的面板

		if (main_panel == null ||second_panel==null) {
			return;
		}
		...
		final BillListPanel billlistpanel = (BillListPanel) second_panel;
