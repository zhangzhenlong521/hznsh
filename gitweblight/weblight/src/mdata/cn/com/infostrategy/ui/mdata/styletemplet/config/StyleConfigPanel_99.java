/**************************************************************************
 * $RCSfile: StyleConfigPanel_99.java,v $  $Revision: 1.5 $  $Date: 2012/09/14 09:22:57 $
 **************************************************************************/
...
public class StyleConfigPanel_99 extends AbstractTempletRefPars {

	private static final long serialVersionUID = -6147862007359706108L;

	private JTextField text = null;

	public StyleConfigPanel_99(String _text) {
	...
	private JPanel getCenterPanel(String _text) {
		...
		JLabel label = new JLabel("自定义Frame类路径:", SwingConstants.RIGHT); //
