 ...
 *
 */
public class GetRefItemVO extends PostfixMathCommand {
	 ...
	 * 取得某一项的值!!
	 */
	public GetRefItemVO(BillPanel _billPanel) {
	...
	public void run(Stack inStack) throws ParseException {
		...
		inStack.push(new RefItemVO(str_id, str_code, str_name)); //置入堆栈!!返回 ComBoxItemVO
	}
