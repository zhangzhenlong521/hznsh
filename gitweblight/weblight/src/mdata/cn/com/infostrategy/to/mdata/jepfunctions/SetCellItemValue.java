 ...
 *
 */
public class SetCellItemValue extends PostfixMathCommand {
	...
	private String getUIValue(String _itemkey, String _itemValue) {
		if (billPanel instanceof BillCellPanel) { //如果是卡片面板
			BillCellPanel cellPanel = (BillCellPanel) billPanel;
			cellPanel.setValueAtTrrigerEditEvent(_itemkey, _itemValue); //
		}
