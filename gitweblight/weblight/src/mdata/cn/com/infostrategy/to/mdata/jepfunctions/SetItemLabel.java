...
/**
 * 设置面板中某一项的列名!!它的返回值应该不会被别的函数使用!!!
 * @author xch
 *
 */
public class SetItemLabel extends PostfixMathCommand {
	...
	private String getUIValue(String _itemkey, String _itemValue) {
		if (billPanel instanceof BillCardPanel) { //如果是卡片面板
			...
			cardPanel.getCompentByKey(_itemkey).getLabel().setText(_itemValue);
