/**************************************************************************
 * $RCSfile: GetLoginUserDeptLinkCode.java,v $  $Revision: 1.4 $  $Date: 2012/09/14 09:22:56 $
 **************************************************************************/
...
public class GetLoginUserDeptLinkCode extends PostfixMathCommand {

	public GetLoginUserDeptLinkCode() {
	...
	public void run(Stack inStack) throws ParseException {
		try {
			checkStack(inStack); //
			String str_result = (String) ClientEnvironment.getInstance().getLoginUserDeptLinkCode();
			if (str_result == null) {
 ...
 * $RCSfile: GetLoginUserDeptLinkCode.java,v $  $Revision: 1.4 $  $Date: 2012/09/14 09:22:56 $
 *
 * $Log: GetLoginUserDeptLinkCode.java,v $
