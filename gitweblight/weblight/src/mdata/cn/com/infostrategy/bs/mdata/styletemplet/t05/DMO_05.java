/**************************************************************************
 * $RCSfile: DMO_05.java,v $  $Revision: 1.4 $  $Date: 2012/09/14 09:22:57 $
 **************************************************************************/
...
public class DMO_05 extends AbstractDMO{

	public DMO_05() {
	}

	public BillVO dealInsert(String _dsName, String _bsInterceptName, BillVO _insertobj) throws Exception {
		IBSIntercept_05 bsIntercept = getIntercept(_bsInterceptName); // 拦截器
	 ...
	 * @throws Exception
	 */
	private IBSIntercept_05 getIntercept(String _interceptName) throws Exception {
		if (_interceptName != null&&!_interceptName.equals( "" )) {
			return (IBSIntercept_05) Class.forName(_interceptName).newInstance();
		} else {
			return null;
		}
	}
 ...
 * *** empty log message ***
 *
 * Revision 1.4  2007/03/15 07:00:32  shxch
 * *** empty log message ***
 *
