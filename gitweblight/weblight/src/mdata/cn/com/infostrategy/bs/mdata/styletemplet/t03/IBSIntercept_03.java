/**************************************************************************
 * $RCSfile: IBSIntercept_03.java,v $  $Revision: 1.4 $  $Date: 2012/09/14 09:22:57 $
 **************************************************************************/
...
public interface IBSIntercept_03 {
...
//	级联删除前处理
	public void dealCommitBeforeCascadeDelete(String _dsName, HashVO[] _deleteobjs) throws Exception; //

	//级联删除后处理
	public void dealCommitAfterCascadeDelete(String _dsName, HashVO[] _deleteobjs) throws Exception; //
 ...
 * *** empty log message ***
 *
 * Revision 1.3  2007/03/08 07:45:09  shxch
 * *** empty log message ***
 *
