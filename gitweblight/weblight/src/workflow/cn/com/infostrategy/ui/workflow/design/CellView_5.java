 ...
 *
 */
public class CellView_5 extends VertexView {
	...
	public class JGraphEllipseRenderer extends VertexRenderer {
		public void paint(Graphics ggg) {
			...
			g2.fillRoundRect(1, 1, d.width - 2, d.height - 2, 30, 20); //
			...
			g2.drawRoundRect(1, 1, d.width - 2, d.height - 2, 30, 20); //
