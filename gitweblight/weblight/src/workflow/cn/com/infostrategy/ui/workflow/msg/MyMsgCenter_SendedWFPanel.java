 ...
 *
 */
public class MyMsgCenter_SendedWFPanel extends JPanel implements ActionListener, BillListHtmlHrefListener {
	...
	public MyMsgCenter_SendedWFPanel(JPanel _parent, String _sql) {
		this.sql = _sql;
	...
	public void onBillListHtmlHrefClicked(BillListHtmlHrefEvent _event) {
		try {
			util.readMsg(_event.getBillListPanel().getBillVO(_event.getRow()), this, 2);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
