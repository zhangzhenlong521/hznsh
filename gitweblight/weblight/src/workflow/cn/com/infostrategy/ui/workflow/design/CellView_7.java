 ...
 *
 */
public class CellView_7 extends VertexView {
	...
	public class JGraphEllipseRenderer extends VertexRenderer {
		public void paint(Graphics ggg) {
			...
			int rectHeight=(d.height - 1)*45/52;//矩形高
			int rectWidth=d.width - 1;//矩形宽
			GeneralPath path = new GeneralPath();
			path.moveTo(1, 1);
			path.lineTo(1, rectHeight);
			path.quadTo(rectWidth/4, rectHeight+rectHeight*3/10, rectWidth/2,rectHeight);
			path.moveTo(rectWidth/2, rectHeight);
			path.quadTo(rectWidth*3/4, rectHeight-rectHeight*3/10, rectWidth, rectHeight);
			path.lineTo(rectWidth, 1);
			path.lineTo(1, 1);
