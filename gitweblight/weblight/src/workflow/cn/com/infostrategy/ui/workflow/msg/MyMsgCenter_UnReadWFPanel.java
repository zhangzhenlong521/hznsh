 ...
 *
 */
public class MyMsgCenter_UnReadWFPanel extends JPanel implements ActionListener, BillListHtmlHrefListener {
	...
	public MyMsgCenter_UnReadWFPanel(JPanel _parent, String _sql) {
		this.sql = _sql;
	...
	public void onBillListHtmlHrefClicked(BillListHtmlHrefEvent _event) {
		try {
			util.readMsg(_event.getBillListPanel().getBillVO(_event.getRow()), this, 0);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
