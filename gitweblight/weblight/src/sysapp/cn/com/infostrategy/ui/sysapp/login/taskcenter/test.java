...
import cn.com.infostrategy.ui.sysapp.login.IndexChartPanel;
import cn.com.infostrategy.ui.sysapp.login.IndexItemTaskPanel;
import cn.com.infostrategy.ui.sysapp.login.IndexRollImagePanel;
import cn.com.infostrategy.ui.sysapp.login.IndexRollMsgPanel;
import cn.com.infostrategy.ui.sysapp.login.SysAppServiceIfc;

/**
 * 首页! 关键类!!!
 * 以前是分组方式,但不够好看,新的机制是仿照网页,有头版图片,有滚动新闻! 每个分组框改成左上角有一个图片!显得像个网页!!!
 * @author xch
 *
 */
public class test extends JPanel implements ItemListener, ActionListener {
	/**
	 * 
	 */
	...
	public test(DeskTopPanel _deskTopPanel) {
		try {
