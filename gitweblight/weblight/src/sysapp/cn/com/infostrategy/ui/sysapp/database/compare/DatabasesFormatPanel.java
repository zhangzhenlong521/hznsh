...
public class DatabasesFormatPanel extends JPanel implements ActionListener{

	/**
	 * 该类实现了注册样版比较结果的调用！
	 */
	private static final long serialVersionUID = -6379812318797733857L;
...
//		jPanel.add(jButtonFor4);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == jButtonFor1){
			...
			map.put("type", "0");
			billHtmlPanel.loadhtml("cn.com.infostrategy.bs.sysapp.database.compare.CreateHtmlForFormatPanelCompare", map);
