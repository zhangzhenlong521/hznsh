...
public class DatabasesTemplet extends JPanel implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == jButtonFor1) {
			...
			map.put("type", "0");
			billHtmlPanel.loadhtml("cn.com.infostrategy.bs.sysapp.database.compare.CreateHtmlForTempletCompare", map);
