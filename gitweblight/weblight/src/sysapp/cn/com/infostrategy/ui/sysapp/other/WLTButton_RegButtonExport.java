...
public class WLTButton_RegButtonExport implements WLTActionListener {
	...
	public void actionPerformed(WLTActionEvent e) throws Exception {
		...
		if (listpanel.getSelectedBillVO() == null) {
			MessageBox.show(listpanel, "请选择一个注册按钮!");
			return;
		}
		...
		String sb_xml = service.exportXMLRegButton(tempcode, selected_rows);
