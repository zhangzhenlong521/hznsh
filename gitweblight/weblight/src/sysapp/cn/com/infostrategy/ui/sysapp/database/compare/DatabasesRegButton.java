...
public class DatabasesRegButton extends JPanel implements ActionListener{
...
//		jPanel.add(jButtonFor4);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == jButtonFor1){
			...
			map.put("type", "0");
			billHtmlPanel.loadhtml("cn.com.infostrategy.bs.sysapp.database.compare.CreateHtmlForRegButtonCompare", map);
