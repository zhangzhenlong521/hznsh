...
public class WLTButton_ProcessExport implements WLTActionListener {
	...
	public void actionPerformed(WLTActionEvent e) throws Exception {
		...
		if (listpanel.getSelectedBillVO() == null) {
			MessageBox.show(listpanel, "请选择一个流程!");
			return;
		}
		...
		String sb_xml = service.exportXMLProcess(tempcode, selected_rows);
