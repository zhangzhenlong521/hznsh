...
public class DeptCheckReportWKPanel extends AbstractWorkPanel implements ActionListener {
	...
	private String[] title = new String[] { "序号", "部门名称" };
	private String[] field = new String[] { "序号", "name" };
	private String[] field_len = new String[] { "序号", "130" };
	private String[] types = new String[] { "部门定性指标", "部门定量指标" };
	private String reportname = "部门考核汇总";
	private String[] v_count_type = new String[] { "合计", "平均" };
	private String[] h_count_type = new String[] { "合计", "平均" };
	private static final Logger logger = WLTLogger.getLogger(DeptCheckReportWKPanel.class);
	...
	public void actionPerformed(ActionEvent e) {
		try {
			if (e.getSource() == billQueryPanel) {
				...
				HashVO[] hvs = ifc.getDeptCheck(checkids, types);
