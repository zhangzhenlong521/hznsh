...
public class JgPersonSalaryReportWKPane extends AbstractWorkPanel implements ActionListener {
    ...
    public void initialize() {
        ...
        billQueryPanel = new BillQueryPanel("REPORTQUERY_CODE5");
    ...
    public String getHJ(String[] strs, int l) {
        ...
        for (int i = 0; i < strs.length; i++) {
            ...
            try {
                ...
                WLTLogger.getLogger(JgPersonSalaryReportWKPane.class).error("", e);
            }
        }
