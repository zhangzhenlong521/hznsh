 ...
 * 
 */
public class PersonOtherReportWKPanel extends AbstractWorkPanel {
	...
	public void initialize() {
		...
		/*		SalaryReportVO srvo_0 = new SalaryReportVO();
				...
				if (querypanel != null) {  15357525258   15385358700
		...
		PersonYqzfReportWKPanel_0.setCondition(" where a.id='" + ClientEnvironment.getCurrSessionVO().getLoginUserId() + "'");
...
//		srvo_1.setH_count_type(new String[] { "合计" });
		...
		PersonStyleeReportWKPanel_1.setCondition(" where a.name='" + ClientEnvironment.getCurrSessionVO().getLoginUserName() + "'");
		...
		PersonGqjlReportWKPanel_2.setCondition(" and b.name='" + ClientEnvironment.getCurrSessionVO().getLoginUserName() + "'");
