...
public class PersonStyleReportWKPanel extends AbstractWorkPanel implements ActionListener {
	...
	public PersonStyleReportWKPanel(SalaryReportVO salaryrvo_) {
	...
	public String getHJ(String[] strs, int l) {
		...
		for (int i = 0; i < strs.length; i++) {
			...
			try {
				...
				WLTLogger.getLogger(PersonStyleReportWKPanel.class).error("", e);
			}
		}
