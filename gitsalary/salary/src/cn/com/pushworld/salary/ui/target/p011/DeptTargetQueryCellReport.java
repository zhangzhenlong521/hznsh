...
public class DeptTargetQueryCellReport extends AbstractWorkPanel implements ActionListener, BillCellHtmlHrefListener {
	/**
	 * 
	 */
	...
	public void initialize() {
		dr = new DefaultStyleReportPanel_2("SAL_PERSON_CHECK_LIST_QUANTIFY_Q1", "");
	...
	private void onQuery() {
		try {
			...
			if (bq.checkValidate()) {
				...
				dr.getBillCellPanel().loadBillCellData(ifc.getDeptTargetQueryCellVO(hashMap));
				dr.getBillCellPanel().setEditable(false);
