...
public class DeptPerformReportBuilderAdapter implements StyleReport_3_BuildDataIFC {
	...
	public HashVO[] buildDataByCondition(HashMap condition, CurrLoginUserVO userVO) throws Exception {
		...
		deptid = (String) condition.get("deptid");
		starttime = (String) condition.get("starttime");
		endtime = (String) condition.get("endtime");
		StringBuffer sb_sql = new StringBuffer();
		sb_sql.append("select t3.reportshowname 指标名称,t1.checkeddeptname 被考核部门 ,t2.checkdate 月份, t1.reportvalue 有效值 from sal_dept_check_score t1 left join sal_target_check_log t2 on t1.logid = t2.id  left join sal_target_list t3 on t1.targetid = t3.id where t1.targettype ='部门定量指标' ");
		...
		sb_sql.append("  group by  t1.targetid,t1.checkeddept,t1.logid");
